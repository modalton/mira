...
describe('Restraunt',function(){
  ...
  describe('Constructor',function(){
    ...
    it("should throw without properly formatted name argument",function(){
      ...
      for(let i of test_arr){
        assert.throws(()=> new Restaurant(i,opening_day,closing_day,opening_time,closing_time),TypeError);
      }
    })
    ...
    it("should throw without properly formatted opening/closing_day arguments",function(){
      const test_arr = [null,undefined,{},[],"1"];
      for(let i of test_arr){
        assert.throws(()=> new Restaurant(name,i,closing_day,opening_time,closing_time),TypeError);
        assert.throws(()=> new Restaurant(name,opening_day,i,opening_time,closing_time),TypeError);
      }
    })
    ...
    it("should throw without properly formatted opening/closing_time argument",function(){
      ...
      for(let i of test_arr){
        assert.throws(()=> new Restaurant(name,opening_day,closing_day,i,closing_time),TypeError);
        assert.throws(()=> new Restaurant(name,opening_day,closing_day,opening_time,i),TypeError);
      }
    });
  ...
  describe("isOpenAt",function(){
    it("should throw without proper datetime argument",function(){
      const test_arr = [null,undefined,{},[],1,"1",{hr:1},{min:2}];
      const rest=  new Restaurant(name,opening_day,closing_day,opening_time,closing_time);
      for(let i of test_arr){       
    ...
    it("should return true for times in, or equal to, range",function(){
      let date = new Date("Wed Jul 18 2018 10:00:00 GMT-0700 (Pacific Daylight Time)");
      let edge_date_early = new Date("Mon Jul 23 2018 08:30:00 GMT-0700 (Pacific Daylight Time)");
      let edge_date_late = new Date("Fri Jul 27 2018 20:00:00 GMT-0700 (Pacific Daylight Time)");
      const rest=  new Restaurant(name,opening_day,closing_day,opening_time,closing_time);
    ...
    it("should return false for correct dates but wrong hours",function(){
      let date_early = new Date("Mon Jul 23 2018 07:30:00 GMT-0700 (Pacific Daylight Time)");
      let date_late = new Date("Fri Jul 27 2018 21:00:00 GMT-0700 (Pacific Daylight Time)");
      const rest=  new Restaurant(name,opening_day,closing_day,opening_time,closing_time);
      ...
      let date_early = new Date("Sun Jul 22 2018 10:17:27 GMT-0700 (Pacific Daylight Time)");
      let date_late = new Date("Sat Jul 21 2018 10:17:27 GMT-0700 (Pacific Daylight Time)");
      const rest=  new Restaurant(name,opening_day,closing_day,opening_time,closing_time);
    ...
    it("should support wrap-around date ranges (ex. tues-sun, fri-tues)",function(){
      ...
      let date_valid = new Date("Mon Jul 23 2018 08:30:00 GMT-0700 (Pacific Daylight Time)");
      let date_invalid = new Date("Wed Jul 25 2018 12:00:00 GMT-0700 (Pacific Daylight Time)");
...
describe("findOpenRestruants", function(){
  ...
  it("should return complete subset of 'open' restraunts at specified date time",function(){
    ...
    const sunday_night_date = new Date("Sun Jul 22 2018 22:30:00 GMT-0700 (Pacific Daylight Time)");
    assert.deepEqual(solution,findOpenRestaurants("restaurants.txt",sunday_night_date));
